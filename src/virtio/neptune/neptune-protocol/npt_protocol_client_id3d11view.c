 ...
 *
 * Client-side COM implementation for id3d11view: out-of-line default
...
static const GUID *const npt_id3d11view_parent_iids[] = {
    &NPT_IID_IUnknown,
...
npt_id3d11view_default_QueryInterface(void *self, REFIID riid, void **ppvObject)
{
    HRESULT hr = npt_com_default_query_interface_chain(
        self, riid, ppvObject, npt_id3d11view_parent_iids);
    if (hr == NPT_S_OK)
        return hr;
...
{
    ID3D11Resource *_raw_ppResource = NULL;
...
{
    dst->QueryInterface = npt_id3d11view_default_QueryInterface;
    dst->AddRef         = npt_id3d11view_default_AddRef;
    dst->Release        = npt_id3d11view_default_Release;
 ...
 * npt_id3d11view_install_default_vtbl(), which is called once at
 * runtime init time from the global client_table init function.
 */
struct npt_id3d11view_client_vtbl npt_id3d11view_default_vtbl_storage;

void
npt_id3d11view_install_default_vtbl(void)
{
    npt_id3d11view_fill_default_vtbl(&npt_id3d11view_default_vtbl_storage);
}
...
npt_id3d11view_client_create(struct npt_device *dev, uint64_t host_id)
{
    ...
    if (!p)
        return NULL;
    npt_com_base_init(p,
        (const void **)&npt_id3d11view_default_vtbl_storage,
        dev, host_id);
    return p;
}

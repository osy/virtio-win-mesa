...
/* triton_shared_texture_desc and npt_shared_texture_desc are field-
 * identical; the export half is the same wire-neutral data both sides
 * carry.  Static asserts pin that so a struct drift trips here. */
